Закінчив роботу над версією переглядача RSTP-потоків із камер, тобто можна підключити, будь-яку камеру, що підтримує RSTP. Він являє собою сторінку html з кількома плеєрами через VLC-плагін.
